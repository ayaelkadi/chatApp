...
const handleSubmit = async ()=>{
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-br from-[#0b0f3b] via-[#1a1f4d] to-[#3c1f7f]
        text-white"
    >
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div
          className="max-w-xl mx-auto bg-white/10 backdrop-blur-lg rounded-2xl 
        ...
        >
          ...
          {images.length > 0 && (
              ...
              {images.map((image, i) => (
                <div className="relative group" key={i}>
                  <img
                    ...
                    className="h-24 rounded-xl border border-pink-500/50 shadow-[0_0_10px_rgba(255, 0, 255,0.3)]"
                  />
                  <div
                    onClick={() =>
                      setImages(images.filter((_, index) => index !== i))
                    }
                    className="absolute hidden group-hover:flex justify-center items-center items-center
                                        top-0 right-0 bottom-0 left-0
                                        bg-black/40 rounded-xl cursor-pointer transition"
                  >
            ...
            <div
                className="flex items-center justify-between p-3 border-t border-500/30"
              >
                <label
                  htmlFor="images"
