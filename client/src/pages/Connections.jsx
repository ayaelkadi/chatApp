...
const Connections = () => {
 ...
 const {connections,pendingConnections, followers, following} = useSelector((state)=> state.connections)
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-br from-[#0b0f3b] via-[#3c1f7f] to-[#3c1f7f]
        text-white py-10"
    >
              ...
              >
                ...
                <div className="flex flex-col gap-3 mt-4">
                  <button
                    ...
                    className="w-full py02 rounded-full bg-gradient-to-r from-indigo-500 to-purple-600
                                        hover:from-indigo-600 hover:to-purple-700 transition text-white font-medium"
                  >
                    View Profile
                  </button>
                  {currentTab === "Following" && (
                    <button
                      ...
                      className="w-full py-2 rounded-full bg-white/20 hover:bg-white/30 text-white transition
                                            font-medium"
                    >
                      Unfollow
                    </button>
                  ...
                  {currentTab === "Connections" && (
                    <button
                      ...
                      className="w-full py-2 rounded-full bg-gradient-to-r from-gray-400 to-teal-500 hover:from-gray-400 hover:to-teal-600 text-white transition font-medium
                      lex items-center justify-center gap-2"
                    >
