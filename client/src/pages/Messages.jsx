    ...
    <div className="min-h-screen relative bg-gradient-to-br from-[#0f172a] via-purple-900  to-black text-white overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto p-6">
        <div className="text-center mb-10">
          <h1
            className="text-5xl font-extrabold bg-gradient-to-r from-purple-400 to-pink-400
        ...
        >
          {connections.map((user, index) => (
            <motion.div
              ...
              className="flex items-center justify-between gap-4 p-5 rounded-xl bg-white/10 backdrop-blur-xl border border-white/20 shadow-lg
                 hover:shadow-purple-500/40 hover:border-purple-400 transition cursor-pointer"
            ...
            >
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="p-3 rounded-full bg-gradient-to-r from-purple-500/30 
                        to-pink-500/30 hover:from-purple-500/30 hover:to-pink-500/30 text-white shadow-md shadow-purple-500/30
                        transition"
                >
