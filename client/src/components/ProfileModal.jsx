  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black/70 backdrop-blur-md">
      <div className="flex items-start sm:items-center justify-center min-h-screen py-8 px-4">
        <div
          className="w-full max-w-2xl mx-auto relative bg-gradient-to-br from-gray-900/85
                via-purple-900/85 to-black/85 border-purple-500/20 rounded-3xl
                 p-6 sm:p-8 shadow-[0_0_40px_rgba(168,85,247,0.6)] max-h-[85vh] overflow-y-auto"
        >
          <h1
            className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400
                    to-pink-500 mb-6 text-center trancking-wide"
          >
            Edit Profile
          </h1>
          <form
            className="space-y-6"
            onSubmit={(e) =>
              toast.promise(handleSaveProfile(e), { loading: "Sving..." })
            }
          >
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              >
                ...
                <img
                  ...
                  className="w-full h-36 sm:h-40 rounded-xl object-cover border border-400/25 shadow-lg"
                />
                <div
                  className="absolute inset-0 hidden group-hover:flex items-center justify-center 
            rounded-full bg-black/40"
            ...
            <div className="flex justify-end space-x-3 pt-6 pb-6">
              <button
                ...
                border border-gray-500 text-gray-300 hover:bg-white/10 transition"
              >
                Cancel
              </button>
              <button
                type="submit"
                className="px-6 py-2 rounded-xl bg-gradient-to-r from-purple-500
                to-pink-600 text-white font-semibold shadow-[0_0_25px_rgba(236,72,153,0.7)]
