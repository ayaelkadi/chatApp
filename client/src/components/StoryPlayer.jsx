...
const renderContent = ()=> {
    switch(viewStory.media_type){
        ...
        case "text":
            return (
                <div className='w-full h-full flex items-center justify-center p-8 text-white text-2xl
                text-center'>
...
useEffect(()=> {
  ...
  return (
    ...
    <div className='absolute top-4 left-24 flex items-center space-x-3 px-4 sm:p-4 sm:px-8 backdrop-blur-2xl rounded bg-black/50'>
